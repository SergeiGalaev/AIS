              ...
              <Table size="sm" bordered>
                <tbody>
                  <tr>
                    ...
                    <td style={{ width: "20%" }}>
                      <Input onChange={(e) => this.handleChange(e)} bsSize="sm" type="text" name="age" value={this.state.form5data.age} findex={this.props.findex}  mask="999" maskChar="" tag={InputMask}/>
                    </td>
                  </tr>
                </tbody>
              </Table>
